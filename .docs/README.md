...
- **[REPO-AND-PUBLISH-LAYOUT.md](REPO-AND-PUBLISH-LAYOUT.md)** — Per-plugin Git repositories with a **single shared publish** workflow at this workspace root (`plugins-live`, manifest, SFTP).
